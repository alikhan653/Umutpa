...
class SupportActivity : AppCompatActivity() {
    ...
    private lateinit var layoutFive: NestedScrollView
    ...
    //Add Medications
    private lateinit var medicationImage: ShapeableImageView
    private lateinit var medicationTitle: TextInputEditText
    private lateinit var medicationDescription: TextInputEditText
    private lateinit var medicationDate: TextInputEditText
    private lateinit var medicationTime: TextInputEditText

    private var imageSelected4: Boolean = false
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        layoutFive = findViewById(R.id.fifth_layout)
        ...
        autoTextView.setOnItemClickListener { parent, view, position, id ->
            when (position) {
                ...
                4 -> {
                    ...
                    medicationTitle = findViewById(R.id.medication_name)
                    medicationDescription = findViewById(R.id.medication_description)
                    medicationDate = findViewById(R.id.medication_date)
                    medicationTime = findViewById(R.id.medication_time)
                    ...
                    medicationDate.setOnClickListener {
                        hideKeyboard(medicationTitle)
                        val dialogInterface: DialogInterface = object : DialogInterface {
                            override fun cancel() {
                            }
                    ...
                    medicationTime.setOnClickListener {
                        val dialogInterface: DialogInterface = object : DialogInterface {
                            override fun cancel() {
                            }
...
//            imageUrl is TIME
        ...
        if (to == "medicines") {
            val userData = MedicineModel(imageUrl, name, number, time, "no")
            if (user != null) {
                val reference: DocumentReference =
                    mFirestore.collection("$to${user.uid}").document()
